...
public class ProtoConsumer {
    private static final String GROUP_ID = "proto-group";
    private static final Logger log = LoggerFactory.getLogger(ProtoConsumer.class);
    ...
    private static Properties propsConsumer() {
        ...
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, KafkaProtobufDeserializerConfig.class);
        props.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest");
        props.put("schema.registry.url", "http://localhost:8081");
        props.put("specific.protobuf.value.type", OrderEventProto.class.getName());
        return props;
    }
}
